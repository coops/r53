...
<ListResourceRecordSetsResponse xmlns="https://route53.amazonaws.com/doc/2011-05-05/">
   ...
   <NextRecordIdentifier>50</NextRecordIdentifier>
    ...
    expected_output = ['''<ListResourceRecordSetsResponse xmlns="https://route53.amazonaws.com/doc/2011-05-05/">
    <ResourceRecordSets>
      <ResourceRecordSet>
         <Name>example.com.</Name>
         <Type>SOA</Type>
   ...
   <NextRecordIdentifier>50</NextRecordIdentifier>
    ...
    zone = 'AAAA'
    self.r53mock.make_request('GET', '/2011-05-05/hostedzone/%s/rrset' % zone).AndReturn(first_resp)
    self.r53mock.make_request('GET', 
      '/2011-05-05/hostedzone/%s/rrset?name=testdoc2.example.com&type=NS&identifier=50' % zone).AndReturn(second_resp)
  ...
  def test_generate_changeset(self):
    old = lxml.etree.XML('''<ResourceRecordSets xmlns="https://route53.amazonaws.com/doc/2011-05-05/">
      <ResourceRecordSet>
         <Name>example.com.</Name>
         <Type>SOA</Type>
         <TTL>900</TTL>
    ...
    new = lxml.etree.XML('''<ResourceRecordSets xmlns="https://route53.amazonaws.com/doc/2011-05-05/">
      <ResourceRecordSet>
         <Name>example.com.</Name>
         <Type>A</Type>
         <TTL>60</TTL>
